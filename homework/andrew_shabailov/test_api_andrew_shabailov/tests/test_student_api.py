...
def test_get_info_by_student_id(
    ...
    read_student.read_status_code_is_200()
...
def test_delete_student(
    ...
    delete_student.delete_student(student_id_to_delete)
    delete_student.delete_status_code_is_200()
...
def test_add_student(
    ...
    create_student.create_status_code_is_200()
